// API Base URL - Configure for Spring Boot backend
...
export const databaseService = {
  ...
  async createDatabase(userId, dbName, dbType, dbVersion, description) {
    const response = await fetch(`${API_BASE_URL}/api/db/create`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async getUserDatabases(userId) {
    const response = await fetch(`${API_BASE_URL}/api/db/user/${userId}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async deleteDatabase(dbId) {
    const response = await fetch(`${API_BASE_URL}/api/db/${dbId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
